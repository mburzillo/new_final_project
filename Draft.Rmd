...
```{r fp_imputations, include = FALSE}
...
stripplot(imp_2_fs, chng5pctasian)
...
stargazer(imp_2_rp_sum_table,
          header = "Racial Divide with Two-Group Segregation Index",
          title = "\\textbf{Racial Polarization in Segregated Cities: B}",
          table.placement = "H")
...
stargazer(imp_3_rp_sum_table,
          header = "Racial Divide with Ideology Control",
          title = "\\textbf{Racial Polarization in Segregated Cities: C}",
          table.placement = "H")
```


For the financial segregation dataset, we similarly fit each of our 5 imputed datasets to the original models from @trounstine_segregation_2016 using this data and then pool the results for each. The results are presented in tables 4-6.
...
stargazer(imp_felm1_sum_table,
          header = "Direct General Expenditure per Capita",
          title = "\\textbf{Effect of Segregation on Overall per Capita City Expenditures: A}",
          table.placement = "H")
```
...
stargazer(imp_felm1_sum_table,
          header = "Direct General Exp. with Changing Demographics",
          title = "\\textbf{Effect of Segregation on Overall per Capita City Expenditures: B}",
          table.placement = "H")
```
...
stargazer(imp_felm1_sum_table,
          header = "Direct General Exp. with Ideology Control",
          title = "\\textbf{Effect of Segregation on Overall per Capita City Expenditures: C}",
          table.placement = "H")
```
