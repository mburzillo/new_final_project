...
fin_imp_1 <-fin_seg %>%
  select(totaltractsf,dgepercap_cpi, H_citytract_NHW_i, diversityinterp,
         ...
         genrevownpercap_cpi, H_citytract_multi_i, diversityinterp, pctblkpopinterp, pctasianpopinterp, pctlatinopopinterp, chng5pctblk, chng5pctlatino, chng5pctasian,medinc_cpi, pctlocalgovworker_100, pctrentersinterp, pctover65, pctcollegegradinterp, logpop, ideology_fill, population)

miss_var_summary(fin_imp_1)

fin_imp <- fin_imp_1 %>%
  select(H_citytract_NHW_i, dgepercap_cpi, highwayspercapNC_cpi, parkspercapNC_cpi,
         policepercapNC_cpi, sewerspercapNC_cpi, welfhoushealthNC_cpi,
         genrevownpercap_cpi, H_citytract_multi_i)
