...
fin_div_tab <- tibble(
  Variable = "Diversity",
  Obs = nrow(fin_div),
  Mean = mean(fin_div$H_citytract_NHW_i, na.rm = T),
  SD = sd(fin_div$H_citytract_NHW_i, na.rm = T),
  Min = min(fin_div$H_citytract_NHW_i, na.rm = T),
  Max = max(fin_div$H_citytract_NHW_i, na.rm = T)
)
