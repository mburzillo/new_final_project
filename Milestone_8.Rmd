...
aggr_plot <- aggr(rp_aggr, bars = TRUE, col=c('navyblue','red'), numbers=TRUE, sortVars=TRUE, cex.axis=.5, gap=3, ylab=c("Histogram of missing data","Pattern"))


md.pattern(rp_aggr, rotate.names = TRUE)
...
```{r results_printing_rp_impute_regressions, echo=FALSE}
